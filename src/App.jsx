...
function App() {
  ...
  async function generateAnswer(e) {
    ...
    try {
      const response = await axios({
        url: "https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent?key=AIzaSyDDyzSkhCQe7tYi9JaUIisZbU8i8jFe7T4",
        method: "post",
        data: {
  ...
  return (
    ...
    >
      <a href="https://github.com/sandeep74177/Chat-AI ">
      ...
      <textarea
        ...
        placeholder="Ask anything in this tech world"
      ></textarea>
      <button
        type="submit"
